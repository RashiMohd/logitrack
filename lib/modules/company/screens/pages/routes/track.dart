...
class DEliveryTrck extends StatefulWidget {
  DEliveryTrck({super.key});

  @override
  State<DEliveryTrck> createState() => _DEliveryTrckState();
}

class _DEliveryTrckState extends State<DEliveryTrck> {
  bool? _loading;
